...
class MensajesControllerTest < ActionController::TestCase
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post :create, mensaje: { consulta: @mensaje.consulta, mail: @mensaje.mail, nombre: @mensaje.nombre, telefono: @mensaje.telefono }
    end
  ...
  test "should update mensaje" do
    patch :update, id: @mensaje, mensaje: { consulta: @mensaje.consulta, mail: @mensaje.mail, nombre: @mensaje.nombre, telefono: @mensaje.telefono }
    assert_redirected_to mensaje_path(assigns(:mensaje))
  end
